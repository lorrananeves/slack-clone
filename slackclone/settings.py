"""
Django settings for slackclone project.
...
WSGI_APPLICATION = 'slackclone.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './slackclone.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
